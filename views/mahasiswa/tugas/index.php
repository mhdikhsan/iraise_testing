...
<div class="col-md-12">            
	<div class="form-group">
		<div class="col-md-12 col-xs-5">
			<h1 class="pull-left"><span class="fa fa-file"></span> <?= $judul; ?> <small>Pilih Mata Kuliah</small></h1>
			<?= CHtml::link("<span class='fa fa-file'> - Kurikulum",Yii::app()->createUrl(Yii::app()->controller->module->id."/tugas/kurikulum"),array("class"=>"btn btn-primary pull-right",'target'=>'blank')); ?>
		</div>
	</div>
</div>
						...
						<?php $no=1;$this->widget('booster.widgets.TbGridView', array(
								...
								'columns'=>array(	
										...
										array(    
										 'header'=>'Detail',
										 'type'=>'raw', 
										 'value'=>'CHtml::link("Selengkapnya",Yii::app()->createUrl(Yii::app()->controller->module->id."/tugas/milis",array("smt"=>$_GET["semester"],"id"=>$data->id_kls)),array("class"=>"btn btn-success btn-xs"))',
										),
								),
						)); ?>
					</div>              
