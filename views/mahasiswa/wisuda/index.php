					...
					<div class="panel-body"> 
						...
						<p>
							...
							<?php if(($modelWisuda->lib_univ_status=='2')&&($modelWisuda->skl_status=='2')): ?>
								...
								<?php $edit=' <a href="'.Yii::app()->request->baseUrl.'/mahasiswa/wisuda/edit"><span class="fa fa-pencil" style="color:green;"></span> edit </a>'; ?>
							<?php else: ?>
								<span class="fa fa-clock-o" style="color:#cc1e1a;"></span>
							<?php endif; ?>
							1. Memiliki <u>Surat Keterangan Lulus</u> (SKL) dan <u>Bebas Pustaka Univ</u>. <?= $edit; ?>
						</p>
						<p>
			...
			<?php if($modelWisuda->validasi_status=="1"): ?>
				<div class="col-md-9 ">		
					<div class="panel panel-success">
						<div class="panel-heading">
							<h3 class="pull-left"><span class="fa fa-check-square-o"></span> Status Mahasiswa</h3>
						</div>
						<div class="panel-body" align="center"> 
							<h1 class="btn-success" style="padding:10px;margin:0px;"><b>Selamat Anda Sudah dinyatakan Lulus</b></h1>
						</div>
					</div>				
				</div>
			<?php else: ?>
