<?php
	...
	$c=Yii::app()->db;
	//nilai
	$sql_nilai="select m.kode_mk,m.nm_mk,m.sks_mk,k.nm_kls,ks.nm_kurikulum_sp,jp.nm_jenj_didik,d.nm_ptk,n.acc_pa, j.jam_mulai, j.jam_selesai, h.hari, n.id_nilai
			from nilai as n
...
<div class="col-md-12">                        
	   <div class="panel panel-default">
	    <div class="panel-heading">
			...
			<div class="btn-group pull-left">
				<h4><font color="red">Memilih Matakuliah Tanpa Kurikulum / Dosen Menyebabkan Tidak Muncul Saat Cetak KRS, Jika sudah Memilih Kelas Tanpa Dosen/Kurikulum Hubungi Admin Prodi Untuk Memasukkan Nama Dosen / Tahun Kurikulum Pada Matakuliah Kelas Perkuliahan Tersebut </font></h4>
			</div>
								...
								<tbody>
									...
									?>
									  <tr id="trow_1"><td class="text-center"><?php echo $no; ?></td>
										...
										<td><?php 
											if($data['acc_pa']=="true"){
												...
												echo "
													...
													<a href='#' class='btn btn-danger mb-control' data-box='#hapus".$data['id_nilai']."'><span class='fa fa-trash-o'></span> hapus</a>
												";
											}
											?>
										</td>
										...
										<!-- END MESSAGE BOX-->
										<div class="message-box animated fadeIn" data-sound="fail" id="hapus<?php echo $data['id_nilai']; ?>">
											<div class="mb-container">
												<div class="mb-middle">
													<div class="mb-title"><span class="fa fa-trash-o"></span> Hapus Mata Kuliah <?php echo $data['nm_mk']; ?> ?</div>
													<div class="mb-content">
														<p>Apakah yakin?</p>                    
														<p>Tekan "Tidak" jika ingin membatalkan. Tekan "Iya" jika yakin ingin melanjutkan.</p>
													</div>
													<div class="mb-footer">
														<div class="pull-right">
															<a href="<?php echo Yii::app()->request->baseUrl; ?>/mahasiswa/matkul/hapus/id/<?php echo $data['id_nilai']; ?>" class="btn btn-success btn-lg">Iya</a>
